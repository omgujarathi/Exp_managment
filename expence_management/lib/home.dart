...
import 'package:expence_management/setting%20page.dart';
...
void getchartdata(){
  ...
  var newFormatxx = DateFormat("yyyy-MM-dd");
  String monthNox = newFormatxx.format(dt11);
    final Future<List<Map<String,dynamic>>>_category11= helper.getcategorywiseThismonthdaata(monthNox.substring(0,7));
    print('res1------------------------------------------------10');
    _category11.then((cat){
      final Future<List<Map<String,dynamic>>> cat11= chart_limit_data();
      cat11.then((cat11){
        setState(() {
        _tableData= cat.map((e) {
          Map<String, dynamic> founded =
          cat11.singleWhere((w) => w['category'] == e['category'], );
          ...
          padding: EdgeInsets.fromLTRB(0, 0, 0, 15),
            child:Card(
              ...
              child: Container(
                ...
                child: Table(
                 border: TableBorder.all(borderRadius: BorderRadius.circular(10.0),color: Color((0xFF5084bc)),width:1.5),
                  columnWidths: {
                    0: FractionColumnWidth(.45),
                  },
                  children: [
                    TableRow(children: [
                      Text('Category',textAlign: TextAlign.center,textScaleFactor: 1.3,style: TextStyle(
                        //color: Color(0xFF5084bc),
                        fontWeight: FontWeight.w600,
                        //fontSize: 18,
                      ),),
                      Text('Limit amount',textAlign: TextAlign.center,textScaleFactor: 1.3,style: TextStyle(
                        //color: Color(0xFF5084bc),
                        fontWeight: FontWeight.w600,
                        //fontSize: 18,
                      ),),
                      Text('amount spent',textAlign: TextAlign.center,textScaleFactor: 1.3,style: TextStyle(
                        //color: Color(0xFF5084bc),
                        fontWeight: FontWeight.w600,
                        //fontSize: 18,
                      ),),
                    ]),
                    for(int ik=0;ik<_tableData.length;ik++)
                    TableRow(children: [
                      Text(_tableData[ik]!['category'],textAlign: TextAlign.center,textScaleFactor: 1.2,style: TextStyle(color: (_tableData[ik]!['limitamount'])<(_tableData[ik]!['amountSpend'])?Colors.red:Colors.black),),
                      Text((_tableData[ik]!['limitamount']).toString(),textAlign: TextAlign.center,textScaleFactor: 1.2),
                      Text((_tableData[ik]!['amountSpend']).toString(),textAlign: TextAlign.center,textScaleFactor: 1.2),
                    ]),
