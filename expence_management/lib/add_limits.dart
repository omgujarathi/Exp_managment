...
class limit_module extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _limit_moduleState();
  }
}

class _limit_moduleState extends State<limit_module> {
  ...
  TextEditingController limit_amountController = TextEditingController();
  @override
 ...
 void addLimit(limit lim) async{
  ...
  void limit_modelBottomsheet(limit lim_list){
    ...
    limit_amountController.text=lim_list.limits_amount.toString();
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                  child: TextFormField(
                                    ...
                                    controller: limit_amountController,
                                    validator: (value) {
                                      if (value == null || value.isEmpty) {
                                        return 'Please enter term';
                                      }
